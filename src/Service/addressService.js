...
const xp = mkad_km.map(e => e[2]);
const yp = mkad_km.map(e => e[1]);
...
export const distanceFromMkad = (x, y) => {
    return Math.min(...mkad_km.map(km => getDistanceFromLatLonInKm(x, y, km[2], km[1])));
};

export const personalToAddress = (personal) => {
    return {data: {
        ...
        city: personal.city,
            ...
            geo_lat: personal.geo_lat,
            geo_lon: personal.geo_lon,
        }}
};