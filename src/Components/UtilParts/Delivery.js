        ...
        <div className='with_footer'>
            <div className='global_giv'>
                <div className='delivery_box'>
                    ...
                    <span>Оплата:
                        <ul style={{marginTop: "5px"}}>
                            <li><s>На сайте</s> [Временно недоступно]</li>
                    ...
                    <span> <p className="delivery_text">
                    ...
                    <span><p className="delivery_text">
                        ...
                        (срок зависит от Банка, который выдал Вашу банковскую карту).</p> <br/>
                        <img className="delivery_image"
