        ...
        <div className='with_footer'>
            <div className='global_giv'>
                <div className='delivery_box'>
                    ...
                    <p>Стоимость доставки c примеркой по МО
                    ...
                    <p>Более подробную информацию Вы можете уточнить у нас по телефону
                        <ul className="phones" style={{marginTop: "5px"}}>
                            <li>+7 (965) 127-81-99</li>
                            <li>+7 (926) 847-24-95</li>
                        </ul>
                    </p>
                    <p>
                    ...
                    <p>Стоимость доставки, фиксированная, во все регионы России - <span
